...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Lotus look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Lotus need to see?`,
    ...
    {
      headline: `What should ${label} Lotus tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[min(78%,42rem)] font-['Collapse'] font-bold uppercase leading-[0.9] tracking-[0.08em] text-midground mix-blend-plus-lighter dark:text-foreground/90"
